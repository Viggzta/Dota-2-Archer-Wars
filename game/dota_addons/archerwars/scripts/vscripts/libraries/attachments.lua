...
--[[
  ...
  -Additionally, ensure that you have the dota2rpg_attachments.xml, dota2rpg_attachments.js, and dota2rpg_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure dota2rpg)", FCVAR_CHEAT )
